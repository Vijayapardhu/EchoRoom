...
import { MessageCircle, Video, Shield, ArrowRight, Zap, Activity } from 'lucide-react';
...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-black selection:bg-cyan-500/30">
            ...
            <motion.div
                ...
                className="max-w-4xl w-full z-10 text-center space-y-12"
            >
